...
public class ModItems {
        ...
        public static final Item VELVET_MOTH_SPAWN_EGG = registerItem("velvet_moth_spawn_egg",
                        new SpawnEggItem(new Item.Properties().setId(VELVET_MOTH_SPAWN_EGG_KEY)
                                        .spawnEgg(ModEntities.VELVET_MOTH)));

        public static final ResourceKey<Item> GLOOM_STALKER_SPAWN_EGG_KEY = ResourceKey.create(
                        BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "gloom_stalker_spawn_egg"));

        public static final Item GLOOM_STALKER_SPAWN_EGG = registerItem("gloom_stalker_spawn_egg",
                        new SpawnEggItem(new Item.Properties().setId(GLOOM_STALKER_SPAWN_EGG_KEY)
                                        .spawnEgg(ModEntities.GLOOM_STALKER)));
        ...
        // Stone & Bricks
        public static final ResourceKey<Item> VESPER_STONE_KEY = ResourceKey.create(BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "vesper_stone"));
        ...
        public static final ResourceKey<Item> VESPER_STONE_BRICKS_KEY = ResourceKey.create(BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "vesper_stone_bricks"));
        public static final Item VESPER_STONE_BRICKS = registerItem("vesper_stone_bricks",
                        new BlockItem(ModBlocks.VESPER_STONE_BRICKS,
                                        new Item.Properties().setId(VESPER_STONE_BRICKS_KEY)));

        public static final ResourceKey<Item> VESPER_STONE_BRICK_STAIRS_KEY = ResourceKey.create(
                        BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "vesper_stone_brick_stairs"));
        public static final Item VESPER_STONE_BRICK_STAIRS = registerItem("vesper_stone_brick_stairs",
                        new BlockItem(ModBlocks.VESPER_STONE_BRICK_STAIRS,
                                        new Item.Properties().setId(VESPER_STONE_BRICK_STAIRS_KEY)));

        public static final ResourceKey<Item> VESPER_STONE_BRICK_SLAB_KEY = ResourceKey.create(
                        BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "vesper_stone_brick_slab"));
        public static final Item VESPER_STONE_BRICK_SLAB = registerItem("vesper_stone_brick_slab",
                        new BlockItem(ModBlocks.VESPER_STONE_BRICK_SLAB,
                                        new Item.Properties().setId(VESPER_STONE_BRICK_SLAB_KEY)));

        public static final ResourceKey<Item> VESPER_STONE_BRICK_WALL_KEY = ResourceKey.create(
                        BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "vesper_stone_brick_wall"));
        public static final Item VESPER_STONE_BRICK_WALL = registerItem("vesper_stone_brick_wall",
                        new BlockItem(ModBlocks.VESPER_STONE_BRICK_WALL,
                                        new Item.Properties().setId(VESPER_STONE_BRICK_WALL_KEY)));

        // --- VELVET WOOD ITEMS ---

        // 1. Stairs
        public static final ResourceKey<Item> VELVET_STAIRS_ITEM_KEY = ResourceKey.create(BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "velvet_stairs"));
        ...
        // 2. Slab
        public static final ResourceKey<Item> VELVET_SLAB_ITEM_KEY = ResourceKey.create(BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "velvet_slab"));
        ...
        // 3. Fence
        public static final ResourceKey<Item> VELVET_FENCE_ITEM_KEY = ResourceKey.create(BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "velvet_fence"));
        ...
        // 4. Fence Gate
        public static final ResourceKey<Item> VELVET_FENCE_GATE_ITEM_KEY = ResourceKey.create(
                        BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "velvet_fence_gate"));
        public static final Item VELVET_FENCE_GATE_ITEM = registerItem("velvet_fence_gate",
                        new BlockItem(ModBlocks.VELVET_FENCE_GATE,
                                        new Item.Properties().setId(VELVET_FENCE_GATE_ITEM_KEY)));

        // 5. Door
        public static final ResourceKey<Item> VELVET_DOOR_ITEM_KEY = ResourceKey.create(BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "velvet_door"));
        ...
        // 6. Trapdoor
        public static final ResourceKey<Item> VELVET_TRAPDOOR_ITEM_KEY = ResourceKey.create(
                        BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "velvet_trapdoor"));
        public static final Item VELVET_TRAPDOOR_ITEM = registerItem("velvet_trapdoor",
                        new BlockItem(ModBlocks.VELVET_TRAPDOOR,
                                        new Item.Properties().setId(VELVET_TRAPDOOR_ITEM_KEY)));

        // 7. Button
        public static final ResourceKey<Item> VELVET_BUTTON_ITEM_KEY = ResourceKey.create(BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "velvet_button"));
        ...
        // 8. Pressure Plate
        public static final ResourceKey<Item> VELVET_PRESSURE_PLATE_ITEM_KEY = ResourceKey.create(
                        BuiltInRegistries.ITEM.key(),
                        Identifier.fromNamespaceAndPath(VesperWilds.MOD_ID, "velvet_pressure_plate"));
        public static final Item VELVET_PRESSURE_PLATE_ITEM = registerItem("velvet_pressure_plate",
                        new BlockItem(ModBlocks.VELVET_PRESSURE_PLATE,
                                        new Item.Properties().setId(VELVET_PRESSURE_PLATE_ITEM_KEY)));
        ...
        public static final Item GLINT_BERRIES = registerItem("glint_berries",
                        new BlockItem(
                                        ...
                                        new Item.Properties().setId(GLINT_BERRIES_KEY)
        ...
        public static final Item DEEPSLATE_VESPERITE_ORE_ITEM = registerItem("deepslate_vesperite_ore",
                        new BlockItem(ModBlocks.DEEPSLATE_VESPERITE_ORE,
                                        new Item.Properties().setId(DEEPSLATE_VESPERITE_ORE_KEY)));
        ...
        public static final Item EMBER_SHELF_FUNGUS = registerItem("ember_shelf_fungus",
                        new BlockItem(ModBlocks.EMBER_SHELF_FUNGUS,
                                        new Item.Properties().setId(EMBER_SHELF_FUNGUS_KEY)));
